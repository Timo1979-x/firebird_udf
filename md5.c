 ...
 *
 * File Name:	md5.c
 * Description: this module contains routines to the
 * implementation of the md5 algorithm as described in RFC1321
 * and was originally written by Quentin Carbonneaux <qcarbonneaux@gmail.com> 
 * adapted for FreeAdhoc UDF by Lional Hagege 2009-08-28
 * for exported functions list see md5.h
 *
...
// OBSOLETE 
static void md5_memcopy (unsigned char *dest, unsigned char *src, const unsigned int count)
{
	unsigned int i;
